namespace Shiio_External_R6_ESP.Memory
{
    public struct Offsets
    {
        ...
        public const int ADDRESS_GLOWMANAGER = 0x5F441A0;
        ...
        //Game -> GlowManager ->
        public const int OFFSET_GLOWMANAGER_GLOWBASE = 0xB8;
        public const int OFFSET_GLOWMANAGER_COLOR_RED = 0x110;
        public const int OFFSET_GLOWMANAGER_COLOR_GREEN = OFFSET_GLOWMANAGER_COLOR_RED + 0x4;
        public const int OFFSET_GLOWMANAGER_COLOR_BLUE = OFFSET_GLOWMANAGER_COLOR_GREEN + 0x4;
        public const int OFFSET_GLOWMANAGER_OPACITY = 0x13C;
        public const int OFFSET_GLOWMANAGER_STARTDISTANCE = 0x134;
        public const int OFFSET_GLOWMANAGER_DISTANCE = 0x138;
    }
}
