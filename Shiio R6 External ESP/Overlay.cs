using static Shiio_External_R6_ESP.Imports.User32;
...
using Shiio_External_R6_ESP.Data;
...
namespace Shiio_External_R6_ESP
{
    public partial class Overlay : Form
    {
        ...
        private void LoadOverlay(object sender, EventArgs e)
        {
            ...
            // Initialize DirectX
            _Device = new WindowRenderTarget(_Factory, new RenderTargetProperties(new PixelFormat(SharpDX.DXGI.Format.R8G8B8A8_UNorm, AlphaMode.Premultiplied)),
                _RenderProperties);
        ...
        private void DirectXThread(object sender)
        {
            ...
            while (_Running)
            {
                ...
                BoxColorBrush = new SolidColorBrush(_Device, new RawColor4(MainForm.BoxColor.R / 255.0f, MainForm.BoxColor.G / 255.0f, MainForm.BoxColor.B / 255.0f, 1));
                CircleColorBrush = new SolidColorBrush(_Device, new RawColor4(MainForm.CircleColor.R / 255.0f, MainForm.CircleColor.G / 255.0f, MainForm.CircleColor.B / 255.0f, 1));
                SkeletonColorBrush = new SolidColorBrush(_Device, new RawColor4(MainForm.SkeletonColor.R / 255.0f, MainForm.SkeletonColor.G / 255.0f, MainForm.SkeletonColor.B / 255.0f, 1));
                SnaplineColorBrush = new SolidColorBrush(_Device, new RawColor4(MainForm.SnaplineColor.R / 255.0f, MainForm.SnaplineColor.G / 255.0f, MainForm.SnaplineColor.B / 255.0f, 1));
                TextColorBrush = new SolidColorBrush(_Device, new RawColor4(MainForm.TextColor.R / 255.0f, MainForm.TextColor.G / 255.0f, MainForm.TextColor.B / 255.0f, 1));
                ...
                _Device.TextAntialiasMode = SharpDX.Direct2D1.TextAntialiasMode.Cleartype;
